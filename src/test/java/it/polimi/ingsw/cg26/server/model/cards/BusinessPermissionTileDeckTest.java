...
public class BusinessPermissionTileDeckTest {
    ...
    public void setUp() throws Exception {
        ...
        City city = City.createCity("city1name", CityColor.createCityColor("colorname"), new LinkedList<Bonus>());
        cities.add(city);
        ...
        city = City.createCity("city2name", CityColor.createCityColor("colorname"), new LinkedList<Bonus>());
        cities.add(city);
    ...
    public void testDraw2() throws Exception {
        LinkedList<City> cities = new LinkedList<>();
        City city = City.createCity("city2name", CityColor.createCityColor("colorname"), new LinkedList<Bonus>());
        cities.add(city);
        LinkedList<Bonus> bonuses = new LinkedList<>();
        Bonus bonus = new AssistantBonus(4);
        bonuses.add(bonus);
